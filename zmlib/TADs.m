...
for M=inim:endm
    ...
    %%% this part is not necessary because the order of state does not influence to EM fitting
    ...
    %%% this part is not necessary because it is inluded in converter_7col.pl
    %% determine left boundary (2), right boundary (0), no bias (1)
